...
SEED_DESCRIPTION_OVERRIDES = {
    ...
    "event_0017": "9年，王莽代汉称帝，新朝建立，西汉结束。",
...
SEED_POLITY_ID_OVERRIDES = {
    ...
    "event_0009": ["polity_0110", "polity_0167"],
    ...
    "event_0017": ["polity_0134", "polity_0071"],
    "event_0018": ["polity_0071", "polity_0006"],
...
RANGE_ANCHOR_SPECS = [
    ...
    anchor("chu_han_war", -206, -203, "楚汉战争", "这一阶段，刘邦与项羽围绕关中、彭城和中原反复争夺，汉政权在战争中逐渐占上风。", "changan", source_pair=QIN_HAN_SOURCES, related_polity_ids=("polity_0134",)),
    ...
    anchor("xin_wangmang_reform", 9, 24, "新莽改制与社会动荡", "这一阶段，王莽在长安推行复古改制，币制和土地政策反复变动，地方起义不断扩大。", "changan", source_pair=("《汉书》|中国社会科学出版社《中国历史年表数据库》", "https://ctext.org/han-shu/zh|https://www.csspw.com.cn/cpdigitaldetail_15988_2074979.jhtml"), related_polity_ids=("polity_0071",)),
    ...
    anchor("three_kingdoms_balance", 221, 280, "三国鼎立与南北攻守", "这一阶段，魏、蜀、吴分别控制北方、巴蜀和江东，战争与外交围绕荆州、淮南和汉中展开。", "luoyang", source_pair=TONGJIAN_SOURCES, related_polity_ids=("polity_0075", "polity_0127", "polity_0002")),
    ...
    anchor("southern_northern_dynasties", 440, 581, "南北朝制度竞争与民族融合", "这一阶段，南朝以建康为中心延续士族政治，北朝推进均田、府兵和汉化改革，南北长期对峙。", "luoyang", source_pair=TONGJIAN_SOURCES, related_polity_ids=("polity_0030",)),
    ...
    anchor("five_dynasties_ten_kingdoms", 908, 960, "五代十国分裂与重组", "这一阶段，北方五代频繁更替，南方多个政权并立，军事集团和地方财政成为政治核心。", "kaifeng", source_pair=SONG_SOURCES, related_polity_ids=("polity_0048",)),
    ...
    anchor("song_liao_xia_jin", 1005, 1127, "宋辽夏金并立与边疆互市", "这一阶段，北宋、辽、西夏和金先后并立，和战、岁币与互市共同塑造北方边疆秩序。", "kaifeng", source_pair=SONG_SOURCES, related_polity_ids=("polity_0026", "polity_0146", "polity_0131", "polity_0154")),
    anchor("southern_song_jin_yuan", 1128, 1279, "南宋金元对峙与江南发展", "这一阶段，南宋以临安为中心经营江南，金、蒙古和元在北方相继崛起并南下。", "hangzhou_linan", source_pair=SONG_SOURCES, related_polity_ids=("polity_0034", "polity_0154", "polity_0013")),
...
SUPPLEMENTAL_EVENT_SPECS.extend([
    ...
    supp("supp_p1921_ccp_founded", 1921, 20, "event", "中国共产党成立", "1921年，中国共产党第一次全国代表大会在上海召开，随后转至嘉兴南湖完成会议。", "shanghai", importance=5, priority=1, source_pair=REPUBLIC_CIVIL_WAR_SOURCES, related_polity_ids=("polity_0189", "polity_0190", "polity_0191")),
    ...
    supp("supp_p1924_first_united_front", 1924, 10, "institution", "第一次国共合作形成", "1924年，国民党一大在广州召开，联俄、联共、扶助农工政策确立。", "guangzhou", stage="高中", importance=5, priority=1, source_pair=REPUBLIC_SOURCES, related_polity_ids=("polity_0186", "polity_0187")),
    supp("supp_p1924_whampoa", 1924, 20, "institution", "黄埔军校创办", "1924年，黄埔军校在广州创办，为国民革命培养军事骨干。", "guangzhou", importance=4, priority=2, source_pair=REPUBLIC_SOURCES, related_polity_ids=("polity_0186", "polity_0187")),
    ...
    supp("supp_p1926_northern_expedition", 1926, 20, "war", "北伐开始", "1926年，国民革命军从广东出师北伐，目标是打倒北洋军阀并统一全国。", "guangzhou", stage="高中", importance=5, priority=1, source_pair=REPUBLIC_SOURCES, related_polity_ids=("polity_0185", "polity_0187", "polity_0188")),
    supp("supp_p1927_shanghai_purge", 1927, 10, "event", "四一二清党", "1927年，蒋介石在上海发动清党，第一次国共合作破裂，国共内战的长期结构形成。", "shanghai", importance=5, priority=1, source_pair=REPUBLIC_SOURCES, related_polity_ids=("polity_0187", "polity_0188", "polity_0189"), related_people=("蒋介石",)),
    supp("supp_p1927_wuhan_nanjing_split", 1927, 15, "event", "宁汉分裂与合流", "1927年，武汉国民政府与南京国民政府一度分裂，随后国民党内部重组。", "wuhan", importance=4, priority=3, source_pair=REPUBLIC_SOURCES, related_polity_ids=("polity_0187", "polity_0188")),
    supp("supp_p1927_nanchang_uprising", 1927, 20, "war", "南昌起义", "1927年8月，南昌起义爆发，中共开始独立领导武装力量。", "nanchang", importance=5, priority=1, source_pair=REPUBLIC_CIVIL_WAR_SOURCES, related_polity_ids=("polity_0189",)),
    supp("supp_p1927_autumn_harvest", 1927, 30, "war", "秋收起义", "1927年，湘赣边秋收起义后，中共武装转向农村根据地道路。", "changsha", importance=4, priority=2, source_pair=REPUBLIC_CIVIL_WAR_SOURCES, related_polity_ids=("polity_0189",)),
    ...
    supp("supp_p1931_mukden", 1931, 10, "occupation", "九一八事变", "1931年，日本关东军制造九一八事变并迅速占领东北，东北实控格局剧变。", "shenyang", importance=5, priority=1, source_pair=REPUBLIC_WAR_JAPAN_SOURCES, related_polity_ids=("polity_0187", "polity_0188", "polity_0192")),
    ...
    supp("supp_p1936_suiyuan", 1936, 35, "war", "绥远抗战", "1936年，中国军队在绥远抵御日伪支持的进攻，华北边疆抗日情绪上升。", "zhangjiakou", importance=3, priority=4, source_pair=REPUBLIC_WAR_JAPAN_SOURCES, related_polity_ids=("polity_0188", "polity_0196")),
    ...
    supp("supp_p1937_nanjing_fall", 1937, 30, "occupation", "南京陷落", "1937年12月，日军攻占南京，南京国民政府战时迁往重庆。", "nanjing", importance=5, priority=1, source_pair=REPUBLIC_WAR_JAPAN_SOURCES, related_polity_ids=("polity_0187", "polity_0188", "polity_0194")),
    ...
    supp("supp_p1938_guangzhou_fall", 1938, 35, "occupation", "广州沦陷", "1938年，日军攻占广州，华南沿海交通与国统区外援通道受到冲击。", "guangzhou", importance=4, priority=3, source_pair=REPUBLIC_WAR_JAPAN_SOURCES, related_polity_ids=("polity_0188", "polity_0195")),
